...
mod tests {
    ...
    async fn test_migrations_are_idempotent() {
        ...
        let count: (i64,) = sqlx::query_as("SELECT COUNT(*) FROM _sqlx_migrations")
            ...
            .await
            .unwrap();
        // 26 migrations, each applied exactly once.
        assert_eq!(count.0, 26);
    }
    ...
    async fn test_dirty_migration_flag_detected() {
        ...
        let count_before: (i64,) = sqlx::query_as("SELECT COUNT(*) FROM _sqlx_migrations")
            ...
            .await
            .unwrap();
        assert_eq!(count_before.0, 26, "all 26 migrations should be recorded");
    ...
    async fn test_missing_migration_entry_reapplied() {
        ...
        // Verify that all 26 migrations are now recorded.
        let count: (i64,) = sqlx::query_as("SELECT COUNT(*) FROM _sqlx_migrations")
            .fetch_one(&pool)
            .await
            .unwrap();
