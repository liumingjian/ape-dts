...
| Quick | `Oracle <-> GaussDBOracle` bootstrap batch（script） | `bash scripts/e2e/oracle_gaussdboracle_bootstrap.sh` | Oracle XE + GaussDBOracle | 一键回归（snapshot/check/cdc/precheck） |
