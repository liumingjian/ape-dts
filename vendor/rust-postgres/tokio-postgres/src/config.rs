...
pub struct Config {
    ...
    pub(crate) protocol_version_minor: u16,
}
...
impl Config {
    ...
    /// Sets the PostgreSQL wire protocol minor version.
    pub fn protocol_version_minor(&mut self, protocol_version_minor: u16) -> &mut Config {
    ...
    fn param(&mut self, key: &str, value: &str) -> Result<(), Error> {
        match key {
            ...
            "protocolVersion" | "protocol-version" => {
                let minor = parse_protocol_version_minor(value)?;
                self.protocol_version_minor(minor);
            }
            key => {
...
impl fmt::Debug for Config {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        f.debug_struct("Config")
            ...
            .field("protocol_version_minor", &self.protocol_version_minor)
            .finish()
    }
}

fn parse_protocol_version_minor(value: &str) -> Result<u16, Error> {
    match value {
        "351" => Ok(51),
        "350" => Ok(50),
        "3" | "0" => Ok(0),
        _ => value
            .parse()
            .map_err(|_| Error::config_parse(Box::new(InvalidValue("protocolVersion")))),
    }
}
